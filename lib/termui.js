...
(function(){
  ...
  TermUI = (function(){
    ...
    function TermUI(poke, readable, writable){
      ...
      this$.textY = 2;
      this$.redraw();
      this$.charm.position(this$.textX + this$.poke.cursorX, this$.textY + this$.poke.cursorY);
      this$.poke.on('cursor', function(x, y){
        return this$.charm.position(this$.textX + x, this$.textY + y);
      });
      return this$;
    } function ctor$(){} ctor$.prototype = prototype;
    prototype.redraw = function(){
      var title, commandArea, i$, to$, i, results$ = [];
      title = "[=====[" + this.poke.constructor.name + "]=====]";
